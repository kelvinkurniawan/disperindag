...
<html lang="en">
	...
	<body>
		<div class="container py-5">
			<div class="row">
				...
				<div class="col-md-4">
					<div class="card">
						<div class="card-body">
							<h6 class="fw-bold">Tambah Store</h6>
							<form class="store-form">
								<div class="mb-3">
									<label class="form-label">Caption</label>
									<input type="text" class="form-control" placeholder="Caption" name="caption"/>
									<input type="hidden" class="form-control" name="exhibitor_id" value="<?=$id?>"/>
								</div>
								<div class="mb-3">
									<label class="form-label">URL</label>
									<input type="text" class="form-control" placeholder="Image URL" name="url"/>
								</div>
								<div class="mb-3">
									...
									<select class="form-select" name="type">
										...
										<option value="padi">Padi UMKM</option>
									</select>
								</div>
							</form>
							<a href="#" class="btn btn-primary" onclick="saveStore()">Simpan</a>
						</div>
					</div>
				</div>
			</div>
		...
		<script>
			...
			const saveStore = () => {
				const data = convertFormToJSON($(".store-form"));
					...
					res.store.forEach(element => {
						...
						result += `<tr>
							...
							<td style="vertical-align:middle; text-align: center;">
								<a href="#" onclick="deleteStore(${id})" class="link text-danger" style="font-size: 18px"><i class="uil uil-trash"></i></a>
							</td>
						</tr>`
					});
